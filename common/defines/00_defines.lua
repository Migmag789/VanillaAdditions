...
NCountry = {
	...
	POLITICAL_POWER_CAP = 8000.0,					-- Max amount of political power country should have
	...
	BASE_COMMAND_POWER_GAIN = 0.01,				-- base value for daily command power gain
...
NPolitics = {
	...
	BASE_POLITICAL_POWER_INCREASE = 3,	-- Weekly increase of PP.
